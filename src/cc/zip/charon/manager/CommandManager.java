...
import cc.zip.charon.features.command.commands.BindCommand;
import cc.zip.charon.features.command.commands.ClientInfoCommand;
import cc.zip.charon.features.command.commands.ConfigCommand;
import cc.zip.charon.features.command.commands.FriendCommand;
import cc.zip.charon.features.command.commands.HelpCommand;
import cc.zip.charon.features.command.commands.ModuleCommand;
import cc.zip.charon.features.command.commands.PrefixCommand;
import cc.zip.charon.features.command.commands.ReloadCommand;
import cc.zip.charon.features.command.commands.ReloadSoundCommand;
...
public class CommandManager extends Feature {
   ...
   private String clientMessage = "[charon.eu]";
   private String prefix = ".";

   public CommandManager() {
      super("Command");
      this.commands.add(new ClientInfoCommand());
