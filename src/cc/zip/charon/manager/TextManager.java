...
public class TextManager extends Feature {
   ...
   public void init(boolean startup) {
      FontMod cFont = (FontMod)Charon.moduleManager.getModuleByClass(FontMod.class);
   ...
   public void drawString(String text, float x, float y, int color, boolean shadow) {
      if (Charon.moduleManager.isModuleEnabled(FontMod.getInstance().getName())) {
         if (shadow) {
   ...
   public int getStringWidth(String text) {
      return Charon.moduleManager.isModuleEnabled(FontMod.getInstance().getName()) ? this.customFont.getStringWidth(text) : mc.fontRenderer.getStringWidth(text);
   }
