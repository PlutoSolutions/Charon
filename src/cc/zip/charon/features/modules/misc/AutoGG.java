...
public class AutoGG extends Module {
   ...
   private void doAnnounce(String name) {
      this.targetedPlayers.remove(name);
      mc.player.connection.sendPacket(new CPacketChatMessage((String)this.custom.getValue()));
      int u = 0;
      ...
      if (!((String)this.test.getValue()).equalsIgnoreCase("null")) {
         mc.player.connection.sendPacket(new CPacketChatMessage((String)this.test.getValue()));
      }
