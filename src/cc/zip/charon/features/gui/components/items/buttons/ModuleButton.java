...
public class ModuleButton extends Button {
   ...
   private final ResourceLocation logo = new ResourceLocation("textures/charon.png");
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (!this.items.isEmpty()) {
         ...
         drawCompleteImage(this.x - 1.5F + (float)this.width - 7.4F, this.y - 2.2F - (float)Gui.getClickGui().getTextOffset(), 8, 8);
      }
