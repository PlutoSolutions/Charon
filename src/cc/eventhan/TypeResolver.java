   ...
   private static Class<?> resolveRawClass(Type genericType, Class<?> subType, Class<?> functionalInterface) {
      if (genericType instanceof Class) {
         ...
         if (genericType instanceof TypeVariable) {
            ...
            Type genericType1 = (Type)getTypeVariableMap(subType, functionalInterface).get(variable);
            genericType = genericType1 == null ? resolveBound(variable) : resolveRawClass(genericType1, subType, functionalInterface);
         }
